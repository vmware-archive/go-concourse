...
func (fake *FakeTeam) CreatePipe() (atc.Pipe, error) {
...
func (fake *FakeTeam) CreatePipeReturns(result1 atc.Pipe, result2 error) {
...
func (fake *FakeTeam) CreatePipeReturnsOnCall(i int, result1 atc.Pipe, result2 error) {
	fake.CreatePipeStub = nil
